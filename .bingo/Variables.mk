...
$(GOLANGCI_LINT): $(BINGO_DIR)/golangci-lint.mod
	...
	@cd $(BINGO_DIR) && GOWORK=off $(GO) build -mod=mod -modfile=golangci-lint.mod -o=$(GOBIN)/golangci-lint-v2.6.0 "github.com/golangci/golangci-lint/v2/cmd/golangci-lint"
